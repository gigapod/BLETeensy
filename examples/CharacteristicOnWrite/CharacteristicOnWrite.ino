...
// showing how to hide/show the advertising (i.e. making the Teensy
// discoverable or not
//
// Send any byte over USB Serial to toggle the advertising
//
...
// And we have a readable (and notify-able) one with the Teensy's uptime
